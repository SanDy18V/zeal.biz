...
//
//     final getSocialProfile = getSocialProfileFromMap(jsonString);

import 'dart:convert';

GetSocialProfile getSocialProfileFromMap(String str) => GetSocialProfile.fromMap(json.decode(str));

String getSocialProfileToMap(GetSocialProfile data) => json.encode(data.toMap());
...
class GetSocialProfile {
  ...
  factory GetSocialProfile.fromMap(Map<String, dynamic> json) => GetSocialProfile(
