...
//
//     final getBizProfile = getBizProfileFromMap(jsonString);

import 'dart:convert';

GetBizProfile getBizProfileFromMap(String str) => GetBizProfile.fromMap(json.decode(str));

String getBizProfileToMap(GetBizProfile data) => json.encode(data.toMap());
...
class GetBizProfile {
  ...
  factory GetBizProfile.fromMap(Map<String, dynamic> json) => GetBizProfile(
