...
class FirstUpdateBiz extends StatefulWidget {
  const FirstUpdateBiz({Key? key}) : super(key: key);

  @override
  State<FirstUpdateBiz> createState() => _FirstUpdateBizState();
}

class _FirstUpdateBizState extends State<FirstUpdateBiz> {


  final nameBizcontroller=TextEditingController();
  final gstcontroller=TextEditingController();
  final emailcontroller=TextEditingController();
  final comnumbercontroller=TextEditingController();
  final cocpersoncontroller=TextEditingController();
  ...
  Future<void> bizcardapi(BuildContext context) async {
    ...
    if(nameBizcontroller.text.isEmpty){
      MyUtils.showInvaliedtoastMessge("Enter Your Name");
    }
    if(gstcontroller.text.isEmpty){
      MyUtils.showInvaliedtoastMessge("Enter Your GST.NO");
    }
   if(pernumbercontroller.text.isEmpty){
     MyUtils.showInvaliedtoastMessge("Enter Your MobileNo");
   }
   if(cocpersoncontroller.text.isEmpty){
     MyUtils.showInvaliedtoastMessge("Enter Your Contact Person");
   }
   if(pernumbercontroller.text.isEmpty){
     MyUtils.showInvaliedtoastMessge("Enter Your Contact Person Phone No");
   }
   if(websitecontroller.text.isEmpty){
     MyUtils.showInvaliedtoastMessge("Enter Your Website");
   }
   ...
   if(zipcontroller.text.isEmpty){
     MyUtils.showInvaliedtoastMessge("Enter Your Zipcode");
   }
    ...
    var body = {
      ...
      "ConatactPerson": cocpersoncontroller.text.toString() ,
      "ConatactPersonPhoneNo": pernumbercontroller.text.toString(),
      ...
      "Paytm": paytmcontroller.text.toString()+"@paytm",
      "PhonePe": phonepaycontroller.text.toString()+"@PhonePe",
      "GooglePay": gpaycontroller.text.toString()+"@GooglePay",
      "ProfileUrls": [],
      "Services": []
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text("Create Biz card",style: TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.bold),)
      ),
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Company Number",style: TextStyle(
                      fontWeight: FontWeight.bold,fontSize: 16
                  ),)
                ],
              ),
              ...
              child: Container(
                ...
                child: SizedBox(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(left: 25),
                    child: TextFormField(
                      controller: comnumbercontroller,
              ...
              child: Container(
                ...
                child: SizedBox(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(left: 25),
                    child: TextFormField(
                      controller:cocpersoncontroller,
                      keyboardType: TextInputType.text,
                      decoration: InputDecoration(
                        border: InputBorder.none,
                      ),
