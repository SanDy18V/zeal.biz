...
class Createsocial extends StatefulWidget {
  const Createsocial({Key? key}) : super(key: key);

  @override
  State<Createsocial> createState() => _CreatesocialState();
}
...
namecontroller.text = Utils.getsocialprofilesbyid.data!.name ?? "";
biocontroller.text = Utils.getsocialprofilesbyid.data!.bio ?? "";
mobilenumbercontroller.text = Utils.getsocialprofilesbyid.data!.mobileNo ?? "";
emailcontroller.text = Utils.getsocialprofilesbyid.data!.email ??"";
paytmcontroller.text = Utils.getsocialprofilesbyid.data!.paytm ?? "";
phonepaycontroller.text = Utils.getsocialprofilesbyid.data!.phonePe ?? "";
gpaycontroller.text = Utils.getsocialprofilesbyid.data!.googlePay ??"";
  }
...
//ProgressDialog? progressDialog;
  ...
  Future<void> _uploadImages(BuildContext context, var image, String name,
    ...
    updateProfilePicService
        . uploadCompanyLogo2(image, path, name, checkImageValue)
        .then((value) {
      if (value) {
        setState(() {});
  ...
  Future<void> socialcardapi(BuildContext context) async {
    ...
    var body = {
      ...
      "CompanyId":Utils.CompanyIdsocial ,
      "ProfileTypeId": "3",
      "Name": namecontroller.text.toString(),
      "Bio": biocontroller.text.toString(),
      "Email": emailcontroller.text.toString(),
      "MobileNo":mobilenumbercontroller.toString(),
    ...
    var then =socialcardapi.ProfileCardAPi(body,context).then((value) {
      ...
      if (value) {
        ...
        Navigator.push(context, CupertinoPageRoute(builder: (context)=> Social()));
      }
    });
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text("Edit Social card",style: TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.bold),)
      ),
            ...
            Stack(
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: Utils.getsocialprofilesbyid.data!.companyLogo != null ? NetworkImage(Utils.getsocialprofilesbyid.data!.companyLogo):NetworkImage("https://www.nicepng.com/png/detail/357-3576881_a-lot-more-fluid-in-camera-blue-icon.png"),
